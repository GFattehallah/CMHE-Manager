...
export const ConsultationManager: React.FC = () => {
  ...
  return (
    <div className="p-6 flex flex-col lg:flex-row gap-6 h-[calc(100vh-80px)]">
      ...
      <div className={`${showPreview ? 'block' : 'hidden'} w-[210mm] shrink-0 bg-white shadow-xl p-0 overflow-hidden border border-slate-200 relative group transition-all duration-300`}>
         <div className="absolute top-2 right-2 bg-slate-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition pointer-events-none z-10">Aperçu avant impression</div>
         
         <div className="h-full overflow-y-auto p-12 scale-[0.8] origin-top">
            {/* Added ID for PDF generation target */}
